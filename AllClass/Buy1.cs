...
namespace APONALOY.AllClass
{
    public partial class Buy1 : Form
    {
        ...
        private decimal basePrice = 10100000;
        private bool parkingIncluded = true;


        // parking option fields
        private decimal parkingFee = 100000m; // change this value to whatever parking costs

        public Buy1(int userId, Appointment item)
        {
            InitializeComponent();
        ...
        private void Checkoutbutton_Click(object sender, EventArgs e)
        {
            ...
            {
                Flattype = "3 Beds, 3 Baths Flat(Gulshan-2)",
                Price = unitPrice,
