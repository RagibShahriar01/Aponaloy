...
namespace APONALOY.AllClass
{
    public partial class Buy2 : Form
    {
        ...
        private decimal basePrice = 15150000;
        private bool parkingIncluded = true;
        private decimal parkingFee = 150000m;
        public Buy2(int userId, Appointment item)
        {
            InitializeComponent();
        ...
        private void Buy2_Load(object sender, EventArgs e)
        {
        ...
        private void Checkoutbutton_Click(object sender, EventArgs e)
        {
            ...
            {
                Flattype = "3 Beds, 3 Baths Flat(Gulshan-1)",
                Price = unitPrice,
