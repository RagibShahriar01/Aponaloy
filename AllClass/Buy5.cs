...
{
    public partial class Buy5 : Form
    {
        private readonly int currentUserId;
        private readonly Appointment appointment;
        private decimal basePrice = 30100000;
        private bool parkingIncluded = true;
        private decimal parkingFee = 100000m;

        public Buy5(int userId, Appointment item)
        {
            InitializeComponent();
        ...
        private void Buy5_Load(object sender, EventArgs e)
        {
        ...
        private void Checkoutbutton_Click(object sender, EventArgs e)
        {
            ...
            {
                Flattype = "4 Beds, 4 Baths Flat(Dhanmondi)",
                Price = unitPrice,
