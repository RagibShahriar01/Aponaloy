...
{
    public partial class Buy4 : Form
    {
        private readonly int currentUserId;
        private readonly Appointment appointment;
        private decimal basePrice = 20100000;
        private bool parkingIncluded = true;
        private decimal parkingFee = 100000m;

        public Buy4(int userId, Appointment item)
        {
            InitializeComponent();
        ...
        private void Buy4_Load(object sender, EventArgs e)
        {
        ...
        private void Checkoutbutton_Click(object sender, EventArgs e)
        {
            ...
            {
                Flattype = "3 Beds, 3 Baths Flat(Banani)",
                Price = unitPrice,
