...
{
    public partial class Rent6 : Form
    {
        ...
        public Rent6(int userId, Appointment item)
        {
            InitializeComponent();
        ...
        private void Rent6_Load(object sender, EventArgs e)
        {
        ...
        private void Checkoutbutton_Click(object sender, EventArgs e)
        {
            ...
            {
                Flattype = "3 Beds, 3 Baths Flat(Bashundhara R/A)",
                Price = unitPrice,
