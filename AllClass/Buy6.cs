...
{
    public partial class Buy6 : Form
    {

        private readonly int currentUserId;
        private readonly Appointment appointment;
        private decimal basePrice = 9050000;
        private bool parkingIncluded = true;
        private decimal parkingFee = 50000m;


        public Buy6(int userId, Appointment item)
        {
            InitializeComponent();
        ...
        private void Buy6_Load(object sender, EventArgs e)
        {
        ...
        private void Checkoutbutton_Click(object sender, EventArgs e)
        {
            ...
            {
                Flattype = "2 Beds, 2 Baths Flat(Bashundhara R/A)",
                Price = unitPrice,
