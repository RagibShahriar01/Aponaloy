...
{
    public partial class Rent3 : Form
    {
        private readonly int currentUserId;
        private readonly Appointment appointment;
        private decimal basePrice = 45000;
        private bool parkingIncluded = true;
        private decimal parkingFee = 5000m;

        public Rent3(int userId, Appointment item)
        {
            InitializeComponent();
        ...
        private void Rent3_Load(object sender, EventArgs e)
        {
        ...
        private void Checkoutbutton_Click(object sender, EventArgs e)
        {
            ...
            {
                Flattype = "3 Beds, 3 Baths Flat(Niketon)",
                Price = unitPrice,
