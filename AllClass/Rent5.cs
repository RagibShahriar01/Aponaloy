...
{
    public partial class Rent5 : Form
    {
        private readonly int currentUserId;
        private readonly Appointment appointment;
        private decimal basePrice = 14000;
        private bool parkingIncluded = true;
        private decimal parkingFee = 1500m;

        public Rent5(int userId, Appointment item)
        {
            InitializeComponent();
        ...
        private void Rent5_Load(object sender, EventArgs e)
        {
        ...
        private void Checkoutbutton_Click(object sender, EventArgs e)
        {
            ...
            {
                Flattype = "2 Beds, 2 Baths Flat(Rampura)",
                Price = unitPrice,
